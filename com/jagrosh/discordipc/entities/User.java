...
public class User
{
    ...
    public enum DefaultAvatar
    {
        ...
        private static /* synthetic */ DefaultAvatar[] $values() {
            return new DefaultAvatar[] { DefaultAvatar.BLURPLE, DefaultAvatar.GREY, DefaultAvatar.GREEN, DefaultAvatar.ORANGE, DefaultAvatar.RED };
        }
