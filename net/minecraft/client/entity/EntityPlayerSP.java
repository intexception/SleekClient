...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer() {
        ...
        if (this.isCurrentViewEntity()) {
            final UpdateEvent event = new UpdateEvent(this.posX, this.getEntityBoundingBox().minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
            Client.getInstance().getEventBus().post((Object)event);
            ...
            final double d4 = event.getRotationYaw() - this.lastReportedYaw;
            final double d5 = event.getRotationPitch() - this.lastReportedPitch;
            ...
            if (this.ridingEntity == null) {
                ...
                this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.motionX, -999.0, this.motionZ, event.getRotationYaw(), event.getRotationPitch(), this.onGround));
                flag3 = false;
            }
        ...
        Client.getInstance().getEventBus().post((Object)new UpdateEvent(false));
    }
    ...
    public void forceSprinting(final boolean sprinting) {
        super.setSprinting(sprinting);
        this.sprintingTicksLeft = (sprinting ? 600 : 0);
    }
