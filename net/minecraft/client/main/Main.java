...
public class Main
{
    public static void main(final String[] p_main_0_) {
        if (ProtectionUtil.husdhuisgfhusgdrhuifosdguhisfgdhuisfgdhsifgduhsufgidsfdhguisfgdhuoisfguhdiosgfoduhisfghudiugfsidshofugid()) {
            ...
            JOptionPane.showMessageDialog(null, "Please disable any debuggers before running Sleek!", "Error!", 0);
            System.exit(-1);
            return;
        }
        if (!ProtectionUtil.gsudfgyfuisadgfdsouaiygsdeugdsoygfsdhohiusdfhuisdghiudgshiufssfdhiushudsdfuhfdshufdshuisfdhsfdhiusfdhuifsdhuifsdhuisfdhiufsdhiufsdhiusfdhuisfdhuifsdhuifsdhuifsdhiufsdiuhfsdhiufdshuisfdhui()) {
            JOptionPane.showMessageDialog(null, "This version seems to be outdated. Please redownload!", "Error!", 0);
            System.exit(-1);
            return;
        }
        ...
        final OptionSpec<String> optionspec10 = (OptionSpec<String>)optionparser.accepts("username").withRequiredArg().defaultsTo((Object)"NoAccountBozo", (Object[])new String[0]);
