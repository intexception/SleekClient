...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleJoinGame(final S01PacketJoinGame packetIn) {
        ...
        final String server = (Minecraft.getMinecraft().getCurrentServerData() == null) ? "Singleplayer" : Minecraft.getMinecraft().getCurrentServerData().serverIP;
        Client.getInstance().getEventBus().post((Object)new ServerJoinEvent(server, Minecraft.getMinecraft().session.getUsername()));
    }
    ...
    public void addToSendQueue(final Packet p_147297_1_) {
        final PacketEvent packetEvent = new PacketEvent(PacketDirection.INBOUND, p_147297_1_);
    ...
    public void handleCombatEvent(final S42PacketCombatEvent packetIn) {
        ...
        if (packetIn.eventType == S42PacketCombatEvent.Event.END_COMBAT) {
            ...
            this.clientWorldController.getEntityByID(packetIn.field_179774_b);
        }
    }
