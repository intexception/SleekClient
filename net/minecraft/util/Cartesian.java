...
public class Cartesian
{
    ...
    static class Product<T> implements Iterable<T[]>
    {
        ...
        public Iterator<T[]> iterator() {
            final Iterator<T[]> iterator = (Iterator<T[]>)((this.iterables.length <= 0) ? Collections.singletonList(createArray(this.clazz, 0)).iterator() : new ProductIterator((Class)this.clazz, (Iterable[])this.iterables));
            return iterator;
        }
