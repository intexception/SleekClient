...
public class Reflector
{
    ...
    public static ReflectorClass MainMenu;
    public static ReflectorField MainMenu_splashText;
    ...
    static {
        ...
        Reflector.MainMenu = new ReflectorClass(MainMenu.class);
        Reflector.MainMenu_splashText = new ReflectorField(Reflector.MainMenu, String.class);
