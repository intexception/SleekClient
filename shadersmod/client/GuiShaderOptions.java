...
public class GuiShaderOptions extends GuiScreenOF
{
    ...
    public void initGui() {
        ...
        final int k = 30;
        final int l = 20;
        final int i2 = GuiShaderOptions.width - 130;
        final int j2 = 120;
        final int k2 = 20;
        int l2 = 2;
        ...
        if (ashaderoption != null) {
            ...
            for (int i3 = 0; i3 < ashaderoption.length; ++i3) {
                ...
                if (shaderoption != null && shaderoption.isVisible()) {
                    final int j3 = i3 % l2;
                    final int k3 = i3 / l2;
                    final int l3 = Math.min(GuiShaderOptions.width / l2, 200);
                    j = (GuiShaderOptions.width - l3 * l2) / 2;
        ...
        this.buttonList.add(new GuiButton(201, GuiShaderOptions.width / 2 - j2 - 20, GuiShaderOptions.height / 6 + 168 + 11, j2, k2, I18n.format("controls.reset", new Object[0])));
        this.buttonList.add(new GuiButton(200, GuiShaderOptions.width / 2 + 20, GuiShaderOptions.height / 6 + 168 + 11, j2, k2, I18n.format("gui.done", new Object[0])));
    }
    ...
    private void drawTooltips(final int x, final int y, final List buttons) {
        ...
        if (System.currentTimeMillis() >= this.mouseStillTime + i) {
            final int j = GuiShaderOptions.width / 2 - 150;
            int k = GuiShaderOptions.height / 6 - 7;
            if (y <= k + 98) {
                k += 105;
            }
